...
//     0x000C000C
#define BRMAP_2CH_2WY_E                                                                                    \
{                                                                                                         \
     _X_,  _X_,0x00, 0x01,   _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,     \
     _X_,  _X_,0x02, 0x03,   _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_,  _X_         \
}
...
#elif BANK_BMP == 0x000C000C
    #define BANK_MAP        BMAP_2CH_2WY_E
    #define BANK_RMAP        BRMAP_2CH_2WY_E
    #define NUM_BANKS        4
